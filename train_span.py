...
config = Config_span.from_json_file(args.config)
...
if config.per_declaration:
    ...
    train_set = DeclarationMappingDataset_span(config.train_file, max_length=config.max_length, gpu=use_gpu,
                                          no_prompt=(not config.use_prompt))
    print('==============Prepare Dev Set=================')
    dev_set = DeclarationMappingDataset_span(config.dev_file, max_length=config.max_length, gpu=use_gpu,
                                        no_prompt=(not config.use_prompt))
